    ...
    <footer className="bg-gray-900 border-t border-gray-800">
      <div className="container mx-auto px-6 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            <div className="font-cinzel text-2xl font-bold glow-text mb-4">
              DeadLive
            </div>
            <p className="text-gray-400 mb-4">
              Exploring the paranormal across the UK with professional investigations and spiritual services.
            </p>
            <div className="flex gap-4">
              <a href="#" className="w-8 h-8 bg-faded-gold/20 rounded-full flex items-center justify-center hover:bg-faded-gold hover:text-black transition-all duration-300">
